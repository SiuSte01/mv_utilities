...
setup(name='mvUtil',
      ...
      author_email='stephen.siu@lexisnexis.com',
		package_data={
			...
			'scripts/clientScripts/CPM': ['*.R','*.sh','*.msg'],
			'scripts/clientScripts/Memorial_Hermann': ['*.R'],
      ...
      packages=[
			...
			'scripts/clientScripts/Memorial_Hermann',
      ...
      scripts=[
			...
			'scripts/clientScripts/CPM/run_monthly_INA_refresh_CPM',
			'scripts/clientScripts/Memorial_Hermann/MH_Copy_Delivery_Files',
