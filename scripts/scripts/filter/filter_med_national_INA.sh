...
cp /vol/cs/CS_PayerProvider/Ryan/utilities/templates/filter_inputs_med_national.txt $inputs
...
cp $inputs $path/national_filter/med_nat_filter_inputs.txt

echo "running filter"
#nohup perl /home/drajagopalan/udrive/Network/DiagFocus/ABCode/terrfilter_new.pl $path/national_filter/med_nat_filter_inputs.txt >| stderrout_filter 2>&1

nohup perl /vol/datadev/Statistics/Projects/HGWorkFlow/Prod_NewWH/INA/terrfilter_new.pl $path/national_filter/med_nat_filter_inputs.txt >| stderrout_filter 2>&1
