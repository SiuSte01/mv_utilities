...
#echo "$missing_string"
#"$USER@healthmarketscience.com" This was the OG gangster email thing
if [ "X$missing_string" != "X" ];then

 printf "The following networks are missing:\n"$missing_string | mail "Katherine.Eaton@lexisnexisrisk.com" "Rachael.Stephano@lexisnexisrisk.com" -s "Network Filter Status"
else
 printf "All network files present.\n" | mail "Katherine.Eaton@lexisnexisrisk.com" "Rachael.Stephano@lexisnexisrisk.com" -s "Network Filter Status"
fi
