...
month<-"April"
year<-"2018"
old_deliverable<-"2018-03-01"
new_deliverable<-"2018-04-01"
new_month<-paste(month,year,sep=" ")

#outpaths
monthpath<-paste("T://HealthGrades/Monthly_Masterfile/",new_deliverable,"/delivery",sep="")
...
#old files
oldfolder<-paste("T://HealthGrades/Monthly_Masterfile/",old_deliverable,"/delivery/",sep="")
path<-paste(oldfolder,list.files(oldfolder,pattern="HG_MasterFile_QA_report.xlsx"),sep="")
fr_path<-paste("T://HealthGrades/Monthly_Masterfile/",old_deliverable,"/delivery/Fill_Rates_by_Practitioner_Type.xlsx",sep="")
drop_path<-paste("T://HealthGrades/Monthly_Masterfile/",old_deliverable,"/delivery/PIID_Address_Drop.xlsx",sep="")

#new inputs
folder<-paste("T://HealthGrades/Monthly_Masterfile/",new_deliverable,"/qa",sep="")
colleen_path<-"T://Colleen/HG_MF_Test"
drop_new_path<-paste("T://HealthGrades/Monthly_Masterfile/",new_deliverable,"/milestones/delta/HMS_Individual_Address_Drop_Rpt.tab",sep="")
