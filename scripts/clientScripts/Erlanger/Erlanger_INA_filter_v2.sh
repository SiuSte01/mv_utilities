...
do
 ...
 cp /vol/cs/CS_PayerProvider/Ryan/utilities/Erlanger/piidselectioninputs_template.txt piidselectioninputs.txt
 sed -i s/"REPLACE_INDIVS"/"$temp"_"$joint"_"dx.tab"/g piidselectioninputs.txt
 sed -i s@"REPLACE_SPECIALTIES"@"/vol/cs/CS_PayerProvider/Ryan/utilities/Erlanger/dx_PCP_specialties.txt"@g piidselectioninputs.txt

 ###run makepiidlist.R
 Rscript /vol/homes/drajagopalan/Network/DiagFocus/ABCode/makepiidlist.R
 mv piidlist.txt /vol/cs/CS_PayerProvider/Ryan/utilities/Erlanger/$temp"_"$joint"_"dx_piidlist.txt
 mv piidselectioninputs.txt /vol/cs/CS_PayerProvider/Ryan/utilities/Erlanger/$temp"_"$joint"_"dx_piidselectioninputs.txt
 ...
 sed -i s@"REPLACE_SPECIALTIES"@"/vol/cs/CS_PayerProvider/Ryan/utilities/Erlanger/px_Ortho_specialties.txt"@g piidselectioninputs.txt

 ###run makepiidlist.R
 Rscript /vol/homes/drajagopalan/Network/DiagFocus/ABCode/makepiidlist.R
 mv piidlist.txt /vol/cs/CS_PayerProvider/Ryan/utilities/Erlanger/$temp"_"$joint"_"px_piidlist.txt
 mv piidselectioninputs.txt /vol/cs/CS_PayerProvider/Ryan/utilities/Erlanger/$temp"_"$joint"_"px_piidselectioninputs.txt
 #rm -f piidselectioninputs.txt

 ################
 ###run filter###
 ################
 cp /vol/cs/CS_PayerProvider/Ryan/utilities/Erlanger/filter_inputs_template.txt /vol/cs/CS_PayerProvider/Ryan/utilities/Erlanger/$joint"_"filter.txt

 #replace strings w/ piidlist path
 sed -i s@REPLACE_LIST1@/vol/cs/CS_PayerProvider/Ryan/utilities/Erlanger/$temp"_"$joint"_"dx_piidlist.txt@g /vol/cs/CS_PayerProvider/Ryan/utilities/Erlanger/$joint"_"filter.txt
 sed -i s@REPLACE_LIST2@/vol/cs/CS_PayerProvider/Ryan/utilities/Erlanger/$temp"_"$joint"_"px_piidlist.txt@g /vol/cs/CS_PayerProvider/Ryan/utilities/Erlanger/$joint"_"filter.txt
 ...
 mv /vol/cs/CS_PayerProvider/Ryan/utilities/Erlanger/$joint"_"filter.txt /vol/cs/clientprojects/Tea_Leaves/"$inadate"_PxDx_and_INA/"$inadate"_INA_Emdeon/Ortho_Joint_INA/Ortho_"$joint"/Comb/Filter/
