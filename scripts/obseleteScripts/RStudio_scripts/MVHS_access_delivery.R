...
filepaths<-"O://Product_Development/mmcveigh/2016-10-11_Adventist_AllCodes/milestones" #path to inputs
accessdelivery<-"K://CS_PayerProvider/Ryan/accesstesting/Product_development" #path to output
name<-"2016-10-11_Adventist_AllCodes" #set this to "auto" in order to name based on filestructure. set to anything else for user defined name


########################
inputfile<-"K://CS_PayerProvider/Ryan/utilities/templates/new_prod_test_mvhs.txt" #template file. do not change for SOC product
########################
