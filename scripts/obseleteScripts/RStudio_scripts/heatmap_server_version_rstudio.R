...
project_dir<-"T:/Medtronic_MarketView_SS_ELA/2016_10_27_SS_Sciatica_SpinalStenosis"

#################
###main script###
#################
###check for heatmap
if (file.exists(file.path(project_dir,"milestones/counts/heat_map.tab"))){
  print(paste("Running using",file.path(project_dir,"milestones/counts/heat_map.tab")))
}else{
  stop(paste(file.path(project_dir,"milestones/counts/heat_map.tab"),"does not exist. Exiting."))
}

###load libraries
.libPaths("K://CS_PayerProvider/Ryan/rlibbackup/library")
library("sp",lib.loc = "K://CS_PayerProvider/Ryan/rlibbackup/library")
library("maps",lib.loc = "K://CS_PayerProvider/Ryan/rlibbackup/library")
library("ggplot2",lib.loc = "K://CS_PayerProvider/Ryan/rlibbackup/library")
#library("RColorBrewer", lib.loc="~/R/R-3.2.3/library")
#library("rgdal", lib.loc="~/R/R-3.2.3/library")
library("RColorBrewer",lib.loc = "K://CS_PayerProvider/Ryan/rlibbackup/library")
library("rgdal",lib.loc = "K://CS_PayerProvider/Ryan/rlibbackup/library")
library("mapproj",lib.loc = "K://CS_PayerProvider/Ryan/rlibbackup/library")
library("scales")
...
if ( file.exists(file.path(project_dir,"log.txt"))){
